...
const items = [
    { name: 'Smoky Jollof Rice', price: '₦3,000', tag: 'Popular' },
    { name: 'Fried Rice', price: '₦3,500', tag: null },
    { name: 'Steamed Basmati Rice', price: '₦2,500', tag: null },
    { name: 'Fries (Sweet Potatoes, Yam)', price: '₦2,500', tag: null },
    { name: 'Steamed Vegetable', price: '₦3,500', tag: null },
    { name: 'Mashed Potatoes', price: '₦6,000', tag: null },
    { name: 'Stir-Fry Veggie', price: '₦4,000', tag: null },
    { name: 'Fried Plantain (Dodo)', price: '₦1,500', tag: null },
    { name: 'Creamy Corn-Cobs', price: '₦3,500', tag: null },
    { name: 'Coleslaw', price: '₦2,500', tag: null },
    { name: 'Guacamole', price: '₦1,500', tag: null },
    { name: 'Steamed Broccoli', price: '₦6,500', tag: null },
];
        ...
        <div className="main-meals-page">
            ...
            <div className="mm-hero">
                ...
                <div className="mm-hero-content">
                    ...
                    <h1>Sides</h1>
                    <p>Perfectly crafted sides to complement any meal.</p>
                    ...
                    <div className="mm-list">
                        ...
                        {filtered.length > 0 && (
                            <div className="mm-group-footer">
                                <p className="mm-group-hint">Select your side and place your order.</p>
