...
const items = [
    { name: 'Smoked Chicken Sauce', price: '₦4,500', description: 'Smoked chicken with tomato sauce, mixed with veggies.', tag: 'Popular' },
    { name: 'Fish Sauce', price: '₦3,400', description: '', tag: null },
    { name: 'Naija Pepper Sauce', price: '₦950', description: '', tag: null },
    { name: 'Gizdodo / Beefdodo', price: '₦5,500', description: '', tag: null },
    { name: 'Mixed Herb Sauce', price: '₦2,600', description: '', tag: null },
];
        ...
        <div className="main-meals-page">
            ...
            <div className="mm-hero">
                ...
                <div className="mm-hero-content">
                    ...
                    <h1>Sauces</h1>
                    <p>Bold, flavourful sauces to elevate every bite.</p>
                    ...
                    <div className="mm-list">
                        ...
                        {filtered.length > 0 && (
                            <div className="mm-group-footer">
                                <p className="mm-group-hint">Select your sauce and place your order.</p>
