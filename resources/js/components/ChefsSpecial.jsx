        ...
        <div className="main-meals-page">
            ...
            <div className="mm-hero">
                ...
                <div className="mm-hero-content">
                    ...
                    <p>Signature dishes you won't find anywhere else, chef-crafted and packed with unforgettable taste.</p>
            ...
            <div className="mm-sections">
                <div className="mm-section">
                    ...
                    <div className="mm-list">
                        {filtered.length === 0 ? (
                            <div className="mm-empty">No dishes match your search.</div>
                        ) : (
                            filtered.map((meal, i) => (
                        ...
                        {filtered.length > 0 && (
                            <div className="mm-group-footer">
                                <p className="mm-group-hint">Select your dish and place your order.</p>
